        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                         ...
                         <img src="upload/<?php echo $profilename; ?>" style="width:50px;height:50px;">
                            </span>
        ...
        <ul class="sidebar-menu">
         ...
         <!--  <li class="sub-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="userprofile.php">Profile</a></li>
          ...
          <div class="col-lg-12">
            <div class="profile-widget profile-widget-info">
              <div class="panel-body">
                <div class="col-lg-2 col-sm-2">
                  <h5><?php echo $_SESSION['sessdata']['name'];  ?></h5>
            ...
            ?>
                ...
                <div class="col-lg-4 col-sm-4 follow-info">
                  <p>Hello I’m <h5><?php echo $_SESSION['sessdata']['name'];  ?></h5>, a leading expert in interactive and creative design.</p>
                  <p><?php echo $_SESSION['sessdata']['name'];  ?></p>
                  <p><i class="fa fa-twitter"><h5><?php echo $_SESSION['sessdata']['name'];  ?></h5></i></p>
                  <h6>
                  ...
                  <div id="profile" class="tab-pane">
                    <section class="panel">
                      <div class="bio-graph-heading">
                        Hello I’m                             <?php echo $_SESSION['sessdata']['name'];  ?>
 Smith, a leading expert in interactive and creative design specializing in the mobile medium. My graduation from Massey University with a Bachelor of Design majoring in visual communication.
                      </div>
                      <div class="panel-body bio-graph-info">
                        <h1>Bio Graph</h1>
                        <div class="row">
                          <div class="bio-row">
                            <p><span>First Name </span>:<?php echo $_SESSION['sessdata']['name'];  ?> </p>
                          </div>
                          <!-- <div class="bio-row">

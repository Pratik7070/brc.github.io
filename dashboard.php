...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="dashboard.php" class="logo">Bike <span class="lite">Repairing</span></a>
      <!--logo end-->
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                         ...
                         <img src="upload/<?php echo $profilename;?>" style="width:50px;height:50px;">
                           ...
                           <span> <?php echo $_SESSION['sessdata']['name']; ?></span>
                            <b class="caret"></b>
                        </a>
            <ul class="dropdown-menu extended logout">
              <div class="log-arrow-up"></div>
              <li class="eborder-top">
                <a href="userprofile.php"><i class="icon_profile"></i> My Profile</a>
              </li>
              <!-- <li>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <!-- <li class="sub-menu">
            ...
            <ul class="sub">
                   <!--    <li><a class="" href="adminlogin.php">LOGIN</a></li>
                  ...
                  <ul class="chats">
                    ...
                    <li class="by-other">
                      ...
                      <div class="chat-content">
                        ...
                        <div class="chat-meta">3 hours ago <td><?php echo $_SESSION['sessdata']['name'];  ?></td>></div>
              ...
              <table class="table table-hover personal-task">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span class="profile-ava">
                                        <img alt="" class="simple" src="img/.jpg">
                                    </span>
                    </td>
                  </tr>
                  <tr>
